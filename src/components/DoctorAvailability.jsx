...
function DoctorAvailability({ fetchDoctors }) {
  ...
  return (
    <div className='container flex-column items-center justify-center'>
      <br />
      ...
      <div className='flex-column items-center justify-center'>
        ...
        <br />
        <Form onFinish={handleAddDay} style={{gap:'20px',display: "flex", justifyContent: 'center', alignItems: 'center' }}>
          <Form.Item label="Doctor" name="doctor" className='form-item' style={{ minWidth: '200px' }}>
            <Select
          ...
          <Form.Item label="Available Day" name="availableDays" className='form-item' style={{ minWidth: '200px' }}>
            <DatePicker
          ...
          <Button type="primary" htmlType="submit" style={{ color: "black", borderStyle: "solid", borderColor: "black" ,marginBottom:'24px'}}>
            Add Day
          </Button>
        </Form>
      </div>
