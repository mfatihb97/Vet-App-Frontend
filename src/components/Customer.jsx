  ...
  return (
    <div className="container flex-column items-center justify-center px-8 py-8">
      ...
      <div className='flex-column items-center justify-center'>
        ...
        <br />
          <Form.Item label="Customer Name" className='flex items-center justify-center'>
      ...
      <div className='flex-column items-center justify-center'>
        ...
        <br />
        <Form style={{ display: "flex", gap: "25px", justifyContent: 'center', alignItems: 'center' }} onFinish={handleAddCustomer}>
          <div>
