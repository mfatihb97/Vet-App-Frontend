  ...
  return (
    <div className='container flex-column items-center jutify-center px-8 py-8'>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '5px' }}>
        ...
        <Button type="primary" onClick={handleSearchDate} className='add-button' style={{ marginBottom: '22px' }}>Search</Button>
        <Button type="primary" onClick={handleResetDate} className='add-button' style={{ marginBottom: '22px' }}>Reset</Button>
      </div>
      ...
      <div className='flex flex-col items-center justify-center'>
        ...
        <br />
        <Form
          className="grid grid-cols-1 md:grid-cols-2 gap-2 justify-center items-center w-full max-w-4xl"
