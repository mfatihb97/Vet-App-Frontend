...
const Animal = ({ customers }) => {
  ...
  return (
    <div className="container flex-column items-center justify-center px-8 py-8" >
      <div className='flex-column justify-center items-center'>
        <h1 className='list-headers'>Animal List</h1>
        <br />
        <Form.Item label="Animal Name" style={{ display: 'flex', gap: '10px', marginBottom: '10px', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
      ...
      <div className='flex-column items-center justify-center'>
        ...
        <br />
        <Form style={{ display: "flex", gap: "50px", justifyContent: 'center', alignItems: 'center' }} onFinish={handleAddAnimal} >
          <div>
