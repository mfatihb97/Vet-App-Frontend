...
function Reports({ appointments }) {
  ...
  return (
    <div className="container px-8 py-8">
      ...
      <br />
      <div className=" lg:flex lg:flex-col lg:justify-center lg:items-center md:grid md:grid-cols-1 md:gap-4 sm:grid sm:grid-cols-1 sm:gap-2">
        <h2 className='list-headers'>Add New Report</h2>
        <br />
        <Form onFinish={handleAddReport} className='lg:flex lg:flex-row lg:gap-4'>
          ...
          <Button type="primary" htmlType="submit" className='add-button' style={{ marginBottom: '24px' }}>
            Add Report
          </Button>
        </Form>
      </div>
